...
class OptimBatchRAGModelWithCalculatorReasoningTask3:
    """
    ...
    def __init__(
        ...
        idk_attrs={"domain": ["finance"], "static_or_dynamic": ["dynamic"]},
    ...
    def batch_generate_answer(self, batch: Dict[str, Any]) -> List[str]:
        ...
        batch_search_results_snippets = [
            [search_res["page_snippet"] for search_res in search_results]
        ...
        for idx, (query_embed, search_results_snippets) in enumerate(
            ...
            retrieval_idxs = (-page_cosine_scores).argsort()[:5]
            final_search_results.append(
                [batch_search_results[idx][_page_idx] for _page_idx in retrieval_idxs]
            )
...
If you think the premise of the question is wrong, for example, the question asks information about a person's hasband, but you are sure that the person doesn't have one, you should answer with "Invalid question" without any other words.
