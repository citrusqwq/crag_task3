...
from models.utils_html import get_tables, clean_html, get_paragraphs
...
MAX_CONTEXT_SENTENCE_LENGTH = 400
...
class ChunkTableExtractor:
    ...
    def _extract_chunks(
        ...
        chunks = get_paragraphs(
            clean_html(html_source, remove_links=True),
            cut_len=self.max_context_sentence_length,
        )
        final_chunks = [html_snippet] + chunks
...
class ParagraphBatchRAGModelWithCalculatorReasoning:
    """
    ...
    def __init__(
        ...
        if self.use_table_info:
            ...
            raise ValueError("Table info is required.")
